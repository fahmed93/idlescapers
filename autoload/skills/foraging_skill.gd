...
static func create_methods() -> Array[TrainingMethodData]:
	...
	guam.description = "Forage for dirty guam leaves in the wild."
	...
	marrentill.description = "Forage for dirty marrentill in the wild."
	...
	tarromin.description = "Forage for dirty tarromin in the wild."
	...
	harralander.description = "Forage for dirty harralander in the wild."
	...
	ranarr.description = "Forage for dirty ranarr weed in the wild."
	...
	toadflax.description = "Forage for dirty toadflax in the wild."
	...
	irit.description = "Forage for dirty irit leaves in the wild."
	...
	avantoe.description = "Forage for dirty avantoe in the wild."
	...
	kwuarm.description = "Forage for dirty kwuarm in the wild."
	...
	snapdragon.description = "Forage for dirty snapdragon in the wild."
	...
	cadantine.description = "Forage for dirty cadantine in the wild."
	...
	lantadyme.description = "Forage for dirty lantadyme in the wild."
	...
	dwarf_weed.description = "Forage for dirty dwarf weed in the wild."
	...
	torstol.description = "Forage for dirty torstol, the most powerful herb."
