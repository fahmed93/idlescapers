...
func _load_skills() -> void:
	...
	smithing.color = Color(0.6, 0.6, 0.6)
	smithing.training_methods = _create_smithing_methods()
...
func _create_smithing_methods() -> Array[TrainingMethodData]:
	var methods: Array[TrainingMethodData] = []
	...
	silver_bar.description = "Smelt silver ore into a bar."
	...
	adamantite_bar.description = "Smelt adamantite ore with coal into a bar."
